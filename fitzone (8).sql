...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2022 at 11:27 AM
...
(166, 'weer@gmail.com', '1004', 'trainer');
...
--
ALTER TABLE `appointment_booking`
  MODIFY `b_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=72;
...
--
ALTER TABLE `tbl_login`
  MODIFY `login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=167;
...
--
ALTER TABLE `t_schedule`
  MODIFY `ts_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=137;
